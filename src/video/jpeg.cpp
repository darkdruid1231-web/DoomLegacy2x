...
JPEGTexture::JPEGTexture(const char *n, int l) : LumpTexture(n, l, 0, 0)
{
    ...
    try
    {
        ...
        if (read_image)
        {
            ...
            if (sw_rend)
            {
                ...
                // NOTE: libjpeg can quantize RGB images into a palette. It achieves better tone
                // reproduction than our humble NearestColor(), but sometimes causes ugly pixel
                // artifacts... Probably the Doom palette is to blame.
