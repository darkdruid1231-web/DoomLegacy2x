...
// WritePCXfile
//
bool WritePCXfile(const char *filename, byte *data, int width, int height, byte *palette)
{
...
void M_ScreenShot()
{
    ...
    else
    {
        ...
        // Save the pcx
        // ret = WritePCXfile(lbmname, vid.screens[0], vid.width, vid.height, (byte
        // *)fc.CacheLumpName("PLAYPAL", PU_CACHE));
    }
