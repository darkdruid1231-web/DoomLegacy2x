...
//-----------------------------------------------------------------------------
//
// $Id: p_hacks.cpp 522 2008-01-20 22:42:23Z smite-meister $
//
...
VoodooDoll::VoodooDoll(const PlayerPawn &p) : PlayerPawn(p)
{
    ...
    // victim's geometry links (will get its own in Map::SpawnActor()) TODO should be part of
