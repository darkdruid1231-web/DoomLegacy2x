...
//-----------------------------------------------------------------------------
//
// $Id: p_lights.cpp 485 2007-08-05 13:52:17Z smite-meister $
//
...
lightfx_t::lightfx_t(
    Map *m, sector_t *s, lightfx_e t, short maxl, short minl, short maxt, short mint)
    : sectoreffect_t(m, s)
{
    type = t;
    count = 0;
        ...
        case Glow:
            ...
            if (rate > 0)
            {
                if (currentlight > maxlight)
                {
                    ...
                    //  this reflection, although basically correct, causes unstable oscillations if
                    //  rate is too high!
...
void Map::SpawnStrobeLight(sector_t *sec, short brighttime, short darktime, bool inSync)
{
    ...
    lightfx_t *lfx =
        new lightfx_t(this, sec, lightfx_t::Strobe, maxlight, minlight, brighttime, darktime);
        ...
        switch (type)
        {
            ...
            case lightfx_t::Fade:
                ...
                new lightfx_t(this,
                              ...
                              0,
                              speed.value() >> 10,
                              -1); // use a custom 10.6 fixed point
                break;
...
static int PhaseTable[64] = {128, 112, 96, 80, 64, 48, 32, 32, 16, 16, 16, 0,  0,  0,  0,   0,
...
phasedlight_t::phasedlight_t(Map *m, sector_t *s, int b, int ind) : sectoreffect_t(m, s)
{
    s->lightingdata = this;
