...
//-----------------------------------------------------------------------------
//
// $Id: m_archive.h 533 2009-06-11 08:31:10Z smite-meister $
//
...
class LArchive
{
  ...
  public:
    ...
    inline LArchive &operator<<(Sint32 &c)
    {
        return operator<<(reinterpret_cast<Uint32 &>(c));
    }
    inline LArchive &operator<<(float &c)
    {
        return operator<<(reinterpret_cast<Uint32 &>(c));
    }
    inline LArchive &operator<<(short &c)
    {
        return operator<<(reinterpret_cast<Uint16 &>(c));
    }

    inline LArchive &operator<<(char &c)
    {
        return operator<<(reinterpret_cast<byte &>(c));
    }
    inline LArchive &operator<<(bool &c)
    {
        return operator<<(reinterpret_cast<byte &>(c));
    }
    ...
    template <typename U> inline LArchive &operator<<(vec_t<U> &v)
    {
        operator<<(v.x);
        operator<<(v.y);
        operator<<(v.z);
