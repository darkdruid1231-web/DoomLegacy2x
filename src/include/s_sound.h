...
//-----------------------------------------------------------------------------
//
// $Id: s_sound.h 361 2006-08-03 22:39:20Z smite-meister $
//
...
#define S_TAGLEN 32         // change with care
    ...
    byte multiplicity; ///< how many instances of the sound can be heard simultaneously. 0 means not
                       ///< limited.
...
class soundchannel_t
{
  public:
    ...
    float separation; ///< left/right x^2 separation. 0 is totally left, 0.5 is front, 1 is totally
                      ///< right
    float volume;
    int pitch;
...
class SoundSystem
{
  ...
  public:
    ...
    {
        return mus_playing ? mus_playing->name.c_str() : NULL;
    }
