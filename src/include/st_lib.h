...
//-----------------------------------------------------------------------------
//
// $Id: st_lib.h 463 2007-05-21 23:32:04Z smite-meister $
//
...
class HudMultIcon : public HudWidget
{
  private:
    ...
    const int
        *inum; ///< pointer to current icon number, -1 is a magic value meaning no icon is drawn
