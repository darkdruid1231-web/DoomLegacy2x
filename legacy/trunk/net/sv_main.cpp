...
CV_PossibleValue_t exitmode_cons_t[] = {
    {0, "no"}, {1, "any"}, {2, "personal"}, {3, "all"}, {4, NULL}};
...
consvar_t cv_deathmatch = {
    "deathmatch", "0", CV_NETVAR | CV_NOINIT | CV_CALL, deathmatch_cons_t, Deathmatch_OnChange};
...
consvar_t cv_fraglimit = {
    "fraglimit", "0", CV_NETVAR | CV_CALL | CV_NOINIT, fraglimit_cons_t, FragLimit_OnChange};
consvar_t cv_timelimit = {
    "timelimit", "0", CV_NETVAR | CV_CALL | CV_NOINIT, CV_Unsigned, TimeLimit_OnChange};
...
void Deathmatch_OnChange()
{
    ...
    // dm 1: original weapons are respawned at start, stay when picked up, yield 2.5*ammo (because
    // ammo does not respawn...) dm 2: items respawn, also original weapons are removed when picked
    // up dm 3: items respawn, original weapons are respawned at start, stay when picked up
