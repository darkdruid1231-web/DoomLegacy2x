...
#define TNL_IMPLEMENT_RPC(class, name, args, ...) void class ::name args
...
class BitStream
{
  public:
    ...
    void writeInt(int32_t v, int bits)
    {
        write(&v, bits);
    }
    void writeUInt(uint32_t v, int bits)
    {
        write(&v, bits);
    }
    void writeUInt32(uint32_t val, int bits = 32)
    {
        write(&val, bits);
    }
    ...
    // Position helpers
    void setBitPosition(size_t bit)
    {
        currentBit = bit;
    }
    ...
    bool isAtEnd() const
    {
        return (currentBit >> 3) >= buffer.size();
    }
...
// Utility functions
// ============================================================
inline U32 computeClientIdentityToken(const Address &, const Nonce &)
{
    return 0;
}
...
class NetConnection
{
  public:
    ...
    void setInterface(NetInterface *i)
    {
        mInterface = i;
    }
...
class NetObject
{
  public:
    ...
    virtual bool unpackUpdate(BitStream *)
    {
        return true;
    }
    ...
    int getGhostIndex() const
    {
        return mGhostIndex;
    }
    void setGhostIndex(int idx)
    {
        mGhostIndex = idx;
    }
...
class NetInterface
{
  public:
    ...
    NetConnection *getConnection(int)
    {
        return nullptr;
    }
...
class GhostConnection : public NetConnection
{
  public:
    ...
    NetObject *getGhost(int ghostIndex) const
    {
        return nullptr;
    } // get ghost by index
    int getGhostIndex(const NetObject * /*obj*/) const
    {
        return -1;
    } // get index of ghost
    ...
    NetObject *resolveGhost(int /*ghostIndex*/)
    {
        return nullptr;
    }
    // isGhostAvailable(obj) — is obj already being ghosted to this connection?
    bool isGhostAvailable(NetObject * /*obj*/ = nullptr) const
    {
        return false;
    }
    ...
    virtual bool readConnectRequest(BitStream *, const char **)
    {
        return true;
    }
    ...
    virtual bool readConnectAccept(BitStream *, const char **)
    {
        return true;
    }
...
inline TNL::Address getNetAddress()
{
    return TNL::Address();
}
...
inline const char *getNetAddressString()
{
    return "127.0.0.1";
}
