...
//-----------------------------------------------------------------------------
//
// $Id: r_main.cpp 533 2009-06-11 08:31:10Z smite-meister $
//
...
consvar_t cv_viewsize = {
    "viewsize", "10", CV_SAVE | CV_CALL, viewsize_cons_t, R_SetViewSize}; // 3-12
// CV_PossibleValue_t detaillevel_cons_t[]={{0,"High"},{1,"Low"},{0,NULL}};
// consvar_t cv_detaillevel    =
// {"detaillevel","0",CV_SAVE|CV_CALL,detaillevel_cons_t,R_SetViewSize}; // UNUSED
...
consvar_t cv_bloodtime = {
    "bloodtime", "20", CV_CALL | CV_SAVE, bloodtime_cons_t, BloodTime_OnChange};
...
static void TestAnims()
{
    ...
    state_t *mobjinfo_t::*seqptr[9] = {&mobjinfo_t::spawnstate,
                                       &mobjinfo_t::seestate,
...
void Rend::R_SetupFrame(PlayerInfo *player)
{
    ...
    viewactor = player->pov; // the point of view for this player (usually same as pawn, but may be
                             // a camera too)
