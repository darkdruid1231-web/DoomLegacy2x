...
//-----------------------------------------------------------------------------
//
// $Id: r_draw8.cpp 427 2007-01-31 12:46:04Z smite-meister $
//
...
void R_DrawColumn_8()
{
    ...
    do
    {
        ...
        *dest = dc_colormap[dc_source[(frac.floor()) & 127]];
        ...
        // R_DrawTranslucentColumn_8: *dest = dc_colormap[dc_transmap[(dc_source[frac.floor()] << 8)
        // + *dest]];
...
void R_DrawTranslatedColumn_8()
{
    ...
    do
    {
        ...
        // sprites. Thus the "green" ramp of the player 0 sprite is mapped to gray, red,
        // black/indigo.
...
void R_DrawSpan_8()
{
    ...
    // For efficiency, we software-render only powers-of-two sized textures. Bigger ones are
    // truncated. spot = xbits:ybits  (col-major)
