...
//-----------------------------------------------------------------------------
//
// $Id: info.h 533 2009-06-11 08:31:10Z smite-meister $
//
...
enum mobjtype_t
{
    ...
    MT_PLASMA2,
    MT_LEGACY_END = MT_PLASMA2, // SoM: Hold the place.

    // common things that are always spawned, regardless of flags
    MT_LEGACY_S,
    MT_CAMERA = MT_LEGACY_S, // SMMU camera object
    MT_NODE,
    MT_LEGACY_S_END = MT_NODE, // level nodes
...
struct state_t
{
    ...
    Sint32
        frame; ///< Lowest 15 bits contain the frame number, the rest are flags for visual effects.
...
enum thingframeflag_t
{
    ...
    TFF_FULLBRIGHT = 0x8000, ///< frame always appear at full brightness (fixedcolormap) (torches,
                             ///< muzzle flare, light sources)
