...
__asm__("
    movl $0x12,
    % % ecx.byte 0x0F, 0x32 movl % % edx, (% % edi) movl % % eax, 4(% % edi) movl $0x13,
    % % ecx.byte 0x0F, 0x32 movl % % edx, (% % esi) movl % % eax,
    4(% % esi) "\
...
__asm__("
        xorl
        % % edx,
    % % edx xorl % % eax, % % eax movl $0x12, % % ecx.byte 0x0F, 0x30 movl $0x13, % % ecx.byte 0x0F,
    0x30 "\
: : : " eax ", " ecx ", " edx ")
...
#pragma aux RDMSR_0x12_0x13 = "mov ecx,0x12"                                                       \
                              "db 0x0F,0x32"                                                       \
                              "mov [edi],edx"                                                      \
                              "mov [4+edi],eax"                                                    \
                              "mov ecx,0x13"                                                       \
