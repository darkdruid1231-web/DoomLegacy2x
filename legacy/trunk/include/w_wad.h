...
class FileCache
{
  ...
  public:
    ...
    /// Return the first lump in a file whose name starts with the given four bytes, also returns
    /// the full name of the lump.
    ...
    /// Read size bytes from the lump (starting from the given offset) into dest. Returns the number
