...
//-----------------------------------------------------------------------------
//
// $Id: keys.h 1108 2014-05-17 16:57:46Z smite-meister $
//
...
/// These are the key event codes posted by the keyboard handler, and closely match the SDLKey
/// symbols. 0-127 are ASCII codes. The codes KEY_NUMKB- are reserved for virtual keys.
enum key_input_e
{
