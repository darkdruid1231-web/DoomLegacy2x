...
//-----------------------------------------------------------------------------
//
// $Id: p_ceilng.cpp 485 2007-08-05 13:52:17Z smite-meister $
//
...
//
int Map::EV_DoCeiling(
    unsigned tag, line_t *line, int type, fixed_t speed, int crush, fixed_t height)
{
    sector_t *sec;
...
// constructor
crusher_t::crusher_t(
    Map *m, int ty, sector_t *sec, fixed_t upsp, fixed_t downsp, int cru, fixed_t height)
...
int Map::EV_DoCrusher(
    unsigned tag, int type, fixed_t uspeed, fixed_t dspeed, int crush, fixed_t height)
{
    sector_t *sec;
