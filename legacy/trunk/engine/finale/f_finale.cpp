...
stage_t Doom[] = {{10, 10, F_TextInit, NULL, F_TextTicker, NULL},   // text
                  {1000, 1, F_DoomStart, NULL, NULL, F_DoomDrawer}, // picture
                  {-1}};

stage_t Doom2[] = {{10, 10, F_TextInit, NULL, F_TextTicker, NULL},                      // text
                   {1000, 1, F_StartCast, F_CastResponder, F_CastTicker, F_CastDrawer}, // cast
                   {-1}};

stage_t Heretic[] = {{20, 5, F_TextInit, NULL, F_TextTicker, NULL}, // text
                     {1000, 1, NULL, NULL, NULL, F_HereticDrawer},  // picture
                     {-1}};

stage_t Hexen[] = {{70, 0, F_HexenStart, NULL, NULL, F_HexenDrawer},
...
castinfo_t castorder[] = {{NULL, MT_POSSESSED},
                          {NULL, MT_SHOTGUY},
                          {NULL, MT_CHAINGUY},
                          {NULL, MT_TROOP},
                          {NULL, MT_SERGEANT},
...
void F_CastTicker()
{
    ...
    if (castattacking)
    {
        if (castframes == 24 || caststate == mobjinfo[castorder[castnum].type].seestate)
        {
        stopattack:
            castattacking = false;
            castframes = 0;
