...
//-----------------------------------------------------------------------------
//
// $Id: p_things.cpp 522 2008-01-20 22:42:23Z smite-meister $
//
...
bool DActor::Activate()
{
    ...
    // NOTE: for non-MF_MONSTERs, meleestate (attacksound) is the active state (sound), seestate
    // (seesound) are the deactivated ones.
    // TODO spikes, bell
