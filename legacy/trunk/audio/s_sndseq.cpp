...
//-----------------------------------------------------------------------------
//
// $Id: s_sndseq.cpp 306 2006-02-11 16:26:27Z jussip $
//
...
hexen_seq_t HexenSeqs[NUMSEQ] = {
    {"Platform",
     {PLAT_S(0), PLAT_S(1), PLAT_S(3)}}, // 'stone', 'heavy' and 'creak' platforms are all alike
...
static const char *SOUNDSEQ_cmds[SSEQ_NUMCMDS + 1] = {"xxx",
                                                      "play",
                                                      "playuntildone",
                                                      "playtime",
                                                      "playrepeat",
...
bool ActiveSndSeq::Update()
{
    ...
    switch (seq->data[ip])
    {
        ...
        case SSEQ_VOLUMERAND:
            volume = float(seq->data[ip + 1] +
                           P_Random() % (seq->data[ip + 2] - seq->data[ip + 1] + 1)) /
                     100;
            ip += 3;
            break;
